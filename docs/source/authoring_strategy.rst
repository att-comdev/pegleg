...
.. highlight:: yaml
    ...
    metadata:
      ...
      substitutions:
        ...
        - src:
            schema: aic/SoftwareVersions/v1
        ...
        - src:
            ...
            src: .
          dest:
            path: .values.conf.ks_domains.aic.identity.ldap.user
            pattern: '(^MECHID)'
        - src:
            schema: deckhand/Passphrase/v1
            name: ldap_mechid_password
            path: .
          dest:
            path: .values.conf.ks_domain.aic.identity.ldap.password
    data:
      install:
        no_hooks: false
      upgrade:
            ...
            aic:
              identity:
                ...
                ldap:
                  ...
                  user: "MECHID@itservices.sbc.com"
                  password: MECHID_PASSWORD_REPLACEME
